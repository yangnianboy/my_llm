...
# echo ">>> Evaluation"
# python eval_llm.py --weight full_sft --hidden_size  512 --num_hidden_layers 8 --lora_weight lora_identity
# python api_server.py --weight dpo --hidden_size  512 --num_hidden_layers 8 --lora_weight lora_identity
