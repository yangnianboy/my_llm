...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="gugugaga LoRA Fine-tuning")
    ...
    parser.add_argument('--max_seq_len', default=128, type=int, help="训练的最大截断长度（中文1token≈1.5~1.7字符）")
    ...
    parser.add_argument("--wandb_project", type=str, default="gugugaga-LoRA", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"gugugaga-LoRA-{args.lora_name}-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
