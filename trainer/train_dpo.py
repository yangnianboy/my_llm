...
from model.model_gugugaga import gugugagaConfig
...
def dpo_loss(ref_log_probs, policy_log_probs, mask, beta):
    ...
    # https://github.com/jingyaogong/gugugaga/issues/298
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="gugugaga DPO (Direct Preference Optimization)")
    ...
    parser.add_argument("--use_wandb",default=1, action="store_true", help="是否使用wandb")
    parser.add_argument("--wandb_project", type=str, default="gugugaga-DPO", help="wandb项目名")
    ...
    lm_config = gugugagaConfig(hidden_size=args.hidden_size, num_hidden_layers=args.num_hidden_layers, use_moe=bool(args.use_moe))
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"gugugaga-DPO-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LR-{args.learning_rate}"
